...
var NavigationManager = /*#__PURE__*/function () {
  ...
  return _createClass(NavigationManager, [{
    ...
    value: function initializeEventListeners() {
      var _this = this;
      var draggables = this.navLinks.querySelectorAll('.draggable');
      if (!draggables.length) return; // Guard clause if no draggable items

      draggables.forEach(function (link) {
        link.addEventListener('dragstart', _this.handleDragStart.bind(_this));
        link.addEventListener('dragend', _this.handleDragEnd.bind(_this));
        link.addEventListener('dragover', _this.handleDragOver.bind(_this));
      });
    }
  }, {
    key: "handleDragStart",
    ...
    value: function saveOrder() {
      var order = {};
      this.navLinks.querySelectorAll('.draggable').forEach(function (link, index) {
      ...
      fetch('/updateNavOrder', {
        ...
        return console.log('Order updated:', data);
