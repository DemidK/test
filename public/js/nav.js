...
var NavigationManager = /*#__PURE__*/function () {
  ...
  return _createClass(NavigationManager, [{
    ...
    value: function initializeEventListeners() {
      var _this = this;
      this.navLinks.querySelectorAll('.draggable').forEach(function (link) {
    ...
    value: function handleDragOver(e) {
      e.preventDefault();
      var afterElement = this.getDragAfterElement(e.clientX);
      var currentItem = document.querySelector('.dragging');
    ...
    value: function getDragAfterElement(x) {
      var draggableElements = _toConsumableArray(this.navLinks.querySelectorAll('.draggable:not(.dragging)'));
    ...
    value: function saveOrder() {
      ...
      fetch('/updateNavOrder', {
        ...
        return console.log('Order updated successfully:', data);
