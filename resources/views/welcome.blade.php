...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto">
        ...
        <div class="mt-8 flex justify-center space-x-4">
            ...
            @else
                {{-- ИСПРАВЛЕНИЕ: Добавлен параметр 'schemaName' в вызов route() --}}
                <a href="{{ route('dashboard', ['schemaName' => auth()->user()->schema_name]) }}" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700">Go to Vadības panelis</a>
            @endguest
        </div>
    </div>
</div>
