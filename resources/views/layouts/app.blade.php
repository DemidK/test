                ...
                @if(isset($currentSchemaName))
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" class="pl-4">
                            <a href="{{ route('invoices.index', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Visi rēķini</a>
                            <a href="{{ route('invoices.create', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jauns rēķins</a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" class="pl-4">
                            <a href="{{ route('partners.index', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Visi partneri</a>
                            <a href="{{ route('partners.create', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Jauns partneris</a>
                        </div>
                    </div>
                    ...
                    @auth
                        <div x-data="{ open: false }">
                            ...
                            <div x-show="open" class="pl-4">
                                <a href="{{ route('dashboard', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Vadības panelis</a>
                                <a href="{{ route('configs.index', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100"><i class="fas fa-cog mr-2"></i>Konfigurācijas iestatījumi</a>
                    ...
                    @else
                        <a href="{{ route('login.schema', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Pieslēgties</a>
                        <a href="{{ route('register.user', ['schemaName' => $currentSchemaName]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Reģistrēties</a>
                    @endauth
