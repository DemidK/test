                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($items as $order)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500">{{ $order->identification_number }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500">{{ $order->created_at->format('M d, Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('transportation_orders.show', $order) }}" class="text-blue-600 hover:text-blue-800 p-2">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('transportation_orders.edit', $order) }}" class="text-blue-600 hover:text-blue-800 p-2">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td>
                                </tr>
